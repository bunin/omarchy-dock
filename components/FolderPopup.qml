                        ...
                        Item {
                            ...
                            Item {
                                ...
                                DockDuplicateCapsule {
                                    ...
                                    totalWindows: (modelData && modelData.toplevels) ? modelData.toplevels.length : 0
                                    effectiveTopIndex: subItemRoot.subEffectiveTopIndex
                                    isAppActive: (modelData && modelData.isActive === true && !modelData.isMinimized)
                                    isPreviewing: (subItemRoot.subPreviewTopIndex >= 0)
